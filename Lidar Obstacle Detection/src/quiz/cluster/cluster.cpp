...
void clusterHelper(int id, const std::vector<std::vector<float>>& points, std::vector<int>& cluster, std::vector<bool>& processed, const KdTree* tree, float distanceTol)
{
    cluster.push_back(id);
    processed[id] = true;

    std::vector<int> nearest_ids = tree->search(points[id], distanceTol);
